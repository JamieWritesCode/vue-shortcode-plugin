...
class Vue_Shortcode_Plugin
{
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_style($this->name, plugin_dir_url(__FILE__) . "dist/css/app.css", [], $this->version);
        wp_enqueue_script($this->name, plugin_dir_url(__FILE__) . "dist/js/app.js", ["vue"], $this->version, true);
